...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Homelab":
		...
		case "All":
			...
			var fix bool
			if inputArgs["fix"] != nil {
				err = json.Unmarshal([]byte(inputArgs["fix"]), &fix)
				if err != nil {
		...
		case "BuildCli":
			...
			return (*Homelab).BuildCli(&parent, ctx, source)
		case "BuildCliGo":
			var parent Homelab
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
		...
		case "LintCue":
			...
			return (*Homelab).LintCue(&parent, ctx, source)
		case "LintGo":
			var parent Homelab
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
		...
		case "ValidateNix":
			...
			return (*Homelab).ValidateNix(&parent, ctx, source)
