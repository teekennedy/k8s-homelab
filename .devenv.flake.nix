{
  inputs = let
    ...
    devenv_root = "/Users/tkennedy/projects/k8s-homelab";
    devenv_dotfile = ./.devenv;
    devenv_dotfile_string = ".devenv";
    container_name = null;
    devenv_tmpdir = "/var/folders/fl/12cm0s4j7bl7nmyyf7mxsv680000gn/T/";
    devenv_runtime = "/var/folders/fl/12cm0s4j7bl7nmyyf7mxsv680000gn/T/devenv-5ad12f2";
